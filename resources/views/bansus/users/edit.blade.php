...
<div class="w-full px-6 md:px-8 lg:px-12">
    ...
    <div class="mb-8 text-center">
        <h2 class="text-4xl font-extrabold text-gray-900 leading-tight mb-0">Edit User</h2>
        <div class="mt-3 text-gray-500 text-lg font-normal">Perbarui informasi user {{ $user->name }}</div>
    </div>

    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-xl">
        <div class="px-8 py-6 border-b border-gray-200">
            <h3 class="text-2xl font-bold text-gray-900">Form Edit User</h3>
        </div>

        <form method="POST" action="{{ route('bansus.users.update', $user) }}" class="p-8 space-y-7">
            @csrf
            @method('PATCH')
